...
for i = 1 : 64
    ...
    K{i}.axis = [abs(K{i}.td(1,1) - O(1))/H abs(K{i}.td(1,2) - O(2))/W;...
                abs(K{i}.td(2,1) - O(1))/H abs(K{i}.td(2,2) - O(2))/W;...
                abs(K{i}.td(3,1) - O(1))/H abs(K{i}.td(3,2) - O(2))/W;...
                abs(K{i}.td(4,1) - O(1))/H abs(K{i}.td(4,2) - O(2))/W];
    K{i}.name = i;
